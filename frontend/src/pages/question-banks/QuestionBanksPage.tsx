      ...
      <div className="mb-6 flex gap-4 items-center bg-white p-4 rounded-lg shadow-sm">
        ...
        <div className="flex-1 relative">
            ...
            <input 
                ...
                className="w-full pl-9 pr-4 py-2 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" 
            />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {questionBanks.length === 0 && (
            <div className="col-span-full py-12 flex flex-col items-center justify-center text-gray-400 bg-white rounded-xl border-2 border-dashed border-gray-200">
                ...
                {isAdmin && <p className="text-sm">Bấm "Tạo Ngân hàng" để bắt đầu</p>}
            </div>
        )}
      </div>
                ...
                <div className="p-6 space-y-4">
                   <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all bg-white"
